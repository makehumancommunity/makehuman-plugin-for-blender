...
class Sensor():
    ...
    def beginRecording(sensorType = 'KINECT2'):
        ...
        if sensorType == 'KINECT2':
            ...
            Sensor.jointDict = Kinect2Sensor.JOINTS
    ...
    def stopRecording():
        ...
        bpy.context.scene.MhSensorCameraHeight = METERS_TO_INCHES * millisFromFloor / 1000
        ...
        for idx, id in enumerate(Sensor.trackedBodies):
            ...
            animation.removeTwitching(Sensor.jointDict)
    ...
    def assign(rigInfo, idx, baseActionName):
        Sensor.animationBuffers[idx].assign(rigInfo, baseActionName, rigInfo.getSensorMapping(Sensor.sensorType), Sensor.jointDict)

    @staticmethod
    def oneRight(rigInfo, idx):
        Sensor.animationBuffers[idx].oneRight(rigInfo, rigInfo.getSensorMapping(Sensor.sensorType), Sensor.jointDict)